...
<% if(findById != null) { %>
    ...
    <div class="form-group">
        <label for="memberCheckPassword1">새 비밀번호 확인</label>
    ...
    <input type="button" id="findMemberPassword1" onclick="findMemberPassword1()" value="변경하기"/>
<% } else { %>
	<div class="form-group">
    ...
    <div class="form-group">
        <label for="memberCheckPassword2">새 비밀번호 확인</label>
